...
const iconMap = {
  sprout: (props) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M7 20h10" /><path d="M12 20v-8" /><path d="M12 12c-3 0-6-3-6-6 0-3 3-3 6 0" /><path d="M12 12c3 0 6-3 6-6 0-3-3-3-6 0" />
    </svg>
  ),
  shield: (props) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const Icon = ({ name, size = 20, className = '', ...props }) => {
  const IconComponent = iconMap[name] || iconMap.leaf;
