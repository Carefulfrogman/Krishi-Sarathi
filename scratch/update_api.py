...
new_mock_data = """export const mockData = {
  farms: [
    {
      id: 'f-101',
...
updated_content = re.sub(r'export const mockData = \{.*?\n\};', new_mock_data, content, flags=re.DOTALL)

with open('client/src/services/api.js', 'w') as f:
    f.write(updated_content)

print("Updated mockData in api.js")
